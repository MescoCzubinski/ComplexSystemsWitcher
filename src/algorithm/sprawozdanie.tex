...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{anomaly_scores_original.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{anomaly_scores_ba.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{graph_anomalies_original.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{graph_anomalies_ba.png}
